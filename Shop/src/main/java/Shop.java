...
//
//			entityManager.persist(new User("Ben", "Coulibaly", new GregorianCalendar(1997, 4, 3).getTime(),
//					"ben", "ben", Rolle.ADMIN, Anrede.HERR));
...
//			
//			for (User user : kundenList) {
//				entityManager.persist(user.getWarenkorb());
//			}
//			
...
//		}
	...
	private void addArtikelsIntoDatabase() {
		try {
			appTransaction.begin();
